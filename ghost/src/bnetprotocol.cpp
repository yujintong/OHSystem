...
void CBNETProtocol :: RegisterPythonClass( )
{
	...
	class_<CBNETProtocol>("BNETProtocol", no_init)
		...
		.def("RECEIVE_SID_GETADVLISTEX", &CBNETProtocol::RECEIVE_SID_GETADVLISTEX, return_internal_reference<>())
		...
		.def("SEND_SID_STOPADV", &CBNETProtocol::SEND_SID_STOPADV)
		.def("SEND_SID_GETADVLISTEX", &CBNETProtocol::SEND_SID_GETADVLISTEX)
		...
		.def("SEND_SID_STARTADVEX3", &CBNETProtocol::SEND_SID_STARTADVEX3)
		.def("SEND_SID_NOTIFYJOIN", &CBNETProtocol::SEND_SID_NOTIFYJOIN)
		...
		.def("SEND_SID_CLANMEMBERLIST", &CBNETProtocol::SEND_SID_CLANMEMBERLIST)
...
void CIncomingGameHost :: RegisterPythonClass( )
{
	...
	class_<CIncomingGameHost>("IncomingGameHost", no_init)
		.def_readonly("IP", &CIncomingGameHost::m_IP)
		.def_readonly("port", &CIncomingGameHost::m_Port)
		.def_readonly("gameName", &CIncomingGameHost::m_GameName)
		.def_readonly("hostCounter", &CIncomingGameHost::m_HostCounter)
...
void CIncomingChatEvent :: RegisterPythonClass( )
{
	...
	class_<CIncomingChatEvent>("IncomingChatEvent", no_init)
		.def_readonly("chatEvent", &CIncomingChatEvent::m_ChatEvent)
		.def_readonly("ping", &CIncomingChatEvent::m_Ping)
		.def_readonly("user", &CIncomingChatEvent::m_User)
		.def_readonly("message", &CIncomingChatEvent::m_Message)
...
void CIncomingFriendList :: RegisterPythonClass( )
{
	...
	class_<CIncomingFriendList>("IncomingFriendList", no_init)
		.def_readonly("account", &CIncomingFriendList::m_Account)
		.def_readonly("status", &CIncomingFriendList::m_Status)
		.def_readonly("area", &CIncomingFriendList::m_Area)
		.def_readonly("location", &CIncomingFriendList::m_Location)
		...
		.def("extractStatus", &CIncomingFriendList::ExtractStatus)
		.def("extractArea", &CIncomingFriendList::ExtractArea)
		.def("extractLocation", &CIncomingFriendList::ExtractLocation)
	;
}
...
void CIncomingClanList :: RegisterPythonClass( )
{
	...
	class_<CIncomingClanList>("IncomingClanList", no_init)
		.def_readonly("name", &CIncomingClanList::m_Name)
		.def_readonly("rank", &CIncomingClanList::m_Rank)
		.def_readonly("status", &CIncomingClanList::m_Status)
