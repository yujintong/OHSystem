...
{
    string Out = m_CFG->GetString( "oh_131", "oh_131" );
    UTIL_Replace( Out, "$TEAM$", team);
    return Out;
}

string CLanguage :: StayToSafeStats( )
{
    string Out = m_CFG->GetString( "oh_132", "oh_132" );
    return Out;
}

string CLanguage :: UserForfeitedGame( string user )
{
    string Out = m_CFG->GetString( "oh_133", "oh_133" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: UserForfeitedGameNotify( string team, string votes, string votesneeded )
{
    string Out = m_CFG->GetString( "oh_134", "oh_134" );
    UTIL_Replace( Out, "$TEAM$", team );
    UTIL_Replace( Out, "$VOTES$", votes );
    UTIL_Replace( Out, "$VOTESNEEDED$", votesneeded );
    return Out;
...
string CLanguage :: NoOneHasForfeitedYet( )
{
    string Out = m_CFG->GetString( "oh_135", "oh_135" );
    return Out;
}

string CLanguage :: ErrorForfeitingNoTwoTeamMap( )
{
    string Out = m_CFG->GetString( "oh_136", "oh_136" );
    return Out;
}

string CLanguage :: UserWillObserveGame( string user )
{
    string Out = m_CFG->GetString( "oh_137", "oh_137" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: ErrorObserverGameAlreadyObserver( )
{
    string Out = m_CFG->GetString( "oh_138", "oh_138" );
    return Out;
}

string CLanguage :: UserWillNoLongerObserveGame( string user )
{
    string Out = m_CFG->GetString( "oh_139", "oh_139" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: ErrorRemovingPassProtectionInvalidOption( )
{
    string Out = m_CFG->GetString( "oh_140", "oh_140" );
    return Out;
}

string CLanguage :: ErrorBetInvalidAmount( )
{
    string Out = m_CFG->GetString( "oh_141", "oh_141" );
    return Out;
}

string CLanguage :: ErrorBetInvalidLogicalAmount( )
{
    string Out = m_CFG->GetString( "oh_142", "oh_142" );
    return Out;
}

string CLanguage :: ErrorBetAlreadyTooLate( )
{
    string Out = m_CFG->GetString( "oh_143", "oh_143" );
    return Out;
}

string CLanguage :: UserRequestedToPauseGame( string user )
{
    string Out = m_CFG->GetString( "oh_144", "oh_144" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: GamePauseNotify( )
{
    string Out = m_CFG->GetString( "oh_145", "oh_145" );
    return Out;
}

string CLanguage :: ErrorPausingAlreadyRequested( )
{
    string Out = m_CFG->GetString( "oh_146", "oh_146" );
    return Out;
}

string CLanguage :: UserRequestedToUnPauseGame( string user )
{
    string Out = m_CFG->GetString( "oh_147", "oh_147" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: ErrorUnPausingGameIsntPaused( )
{
    string Out = m_CFG->GetString( "oh_148", "oh_148" );
    return Out;
}

string CLanguage :: ErrorOneTeamHasNoPlayers( )
{
    string Out = m_CFG->GetString( "oh_149", "oh_149" );
    return Out;
}

string CLanguage :: ErrorNotATwoTeamMap( )
{
    string Out = m_CFG->GetString( "oh_150", "oh_150" );
    return Out;
}

string CLanguage :: UserAteACookie( string user )
{
    string Out = m_CFG->GetString( "oh_151", "oh_151" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: UserRemovedCookieNotify( string user )
{
    string Out = m_CFG->GetString( "oh_152", "oh_152" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: ErrorEatACookieNoCookieAvaible( )
{
    string Out = m_CFG->GetString( "oh_153", "oh_153" );
    return Out;
}

string CLanguage :: UserIgnoredPlayer( string user )
{
    string Out = m_CFG->GetString( "oh_154", "oh_154" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: UserUnIgnoredPlayer( string user )
{
    string Out = m_CFG->GetString( "oh_155", "oh_155" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: UserIgnoringAllPlayersNotify( )
{
    string Out = m_CFG->GetString( "oh_156", "oh_156" );
    return Out;
}

string CLanguage :: UserUnIgnoringAllPlayersNotify( )
{
    string Out = m_CFG->GetString( "oh_157", "oh_157" );
    return Out;
}

string CLanguage :: RuleTagNotify( )
{
    string Out = m_CFG->GetString( "oh_158", "oh_158" );
    return Out;
}

string CLanguage :: UserStartedVoteMute( string user, string target )
{
    string Out = m_CFG->GetString( "oh_159", "oh_159" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$TARGET$", target );
    return Out;
}

string CLanguage :: UserStartedVoteMuteVotesNeeded( string team, string votes )
{
    string Out = m_CFG->GetString( "oh_160", "oh_160" );
    UTIL_Replace( Out, "$TEAM$", team);
    UTIL_Replace( Out, "$VOTES$", votes );
    return Out;
}

string CLanguage :: UserStartedVoteMuteVoteExpire( string expire )
{
    string Out = m_CFG->GetString( "oh_161", "oh_161" );
    UTIL_Replace( Out, "$EXPIRE$", expire );
    return Out;
}

string CLanguage :: UserStartedVoteGlobalMute( string user, string target )
{
    string Out = m_CFG->GetString( "oh_162", "oh_162" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$TARGET$", target );
    return Out;
}

string CLanguage :: UserStartedVoteGlobalMuteVotesNeeded( )
{
    string Out = m_CFG->GetString( "oh_163", "oh_163" );
    return Out;
}

string CLanguage :: UserStartedVoteNotify( )
{
    string Out = m_CFG->GetString( "oh_164", "oh_164" );
    return Out;
}

string CLanguage :: SuccessfullyVoteMutedUser( string user )
{
    string Out = m_CFG->GetString( "oh_165", "oh_165" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: UserVotedForMute( string user, string target, string votes )
{
    string Out = m_CFG->GetString( "oh_166", "oh_166" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$TARGET$", target );
    UTIL_Replace( Out, "$VOTES$", votes );
    return Out;
...
string CLanguage :: UserVotedToModeNoVotesOnTeam( )
{
    string Out = m_CFG->GetString( "oh_167", "oh_167" );
    return Out;
}

string CLanguage :: UserVotedToModeNoVotesOnObserver( )
{
    string Out = m_CFG->GetString( "oh_168", "oh_168" );
    return Out;
}

string CLanguage :: ErrorVotingThereIsNoVote( )
{
    string Out = m_CFG->GetString( "oh_169", "oh_169" );
    return Out;
}

string CLanguage :: SuccessfullyInterruptedAutoEnd( )
{
    string Out = m_CFG->GetString( "oh_170", "oh_170" );
    return Out;
}

string CLanguage :: UserVotedForInterruptAutoEnd( string user, string votes )
{
    string Out = m_CFG->GetString( "oh_171", "oh_171" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$VOTES$", votes );
    return Out;
}

string CLanguage :: UserAlreadyVotedForIntteruptAutoEnd( )
{
    string Out = m_CFG->GetString( "oh_172", "oh_172" );
    return Out;
}

string CLanguage :: ErrorVotedAlreadyForMode( )
{
    string Out = m_CFG->GetString( "oh_173", "oh_173" );
    return Out;
}

string CLanguage :: ErrorInvalidModeWasVoted( )
{
    string Out = m_CFG->GetString( "oh_174", "oh_174" );
    return Out;
}

string CLanguage :: UserVotedForMode( string user, string mode )
{
    string Out = m_CFG->GetString( "oh_175", "oh_175" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$MODE$", mode );
    return Out;
}

string CLanguage :: PlayersWhoDidntVoteForMode( string players )
{
    string Out = m_CFG->GetString( "oh_176", "oh_176" );
    UTIL_Replace( Out, "$PLAYERS$", players );
    return Out;
}
...
string CLanguage :: UserForcedMode( string user, string mode )
{
    string Out = m_CFG->GetString( "oh_178", "oh_178" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$MODE$", mode );
    return Out;
}

string CLanguage :: UserRefilledCookieChar( string user, string player )
{
    string Out = m_CFG->GetString( "oh_179", "oh_179" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$PLAYER$", player);
    return Out;
}

string CLanguage :: EnabledAutobalance( )
{
    string Out = m_CFG->GetString( "oh_180", "oh_180" );
    return Out;
}

string CLanguage :: DisabledAutobalance( )
{
    string Out = m_CFG->GetString( "oh_181", "oh_181" );
    return Out;
}

string CLanguage :: UserEnabledNoLag( string user )
{
    string Out = m_CFG->GetString( "oh_182", "oh_182" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: UserDisabledNoLag( string user )
{
    string Out = m_CFG->GetString( "oh_183", "oh_183" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}

string CLanguage :: UserVotedForBalance( string user )
{
    string Out = m_CFG->GetString( "oh_184", "oh_184" );
    UTIL_Replace( Out, "$USER$", user );
    return Out;
}
string CLanguage :: EnabledBalanceForThisGame( )
{
    string Out = m_CFG->GetString( "oh_185", "oh_185" );
    return Out;
}

string CLanguage :: ErrorVotedAlreadyForBalance( )
{
    string Out = m_CFG->GetString( "oh_186", "oh_186" );
    return Out;
}

string CLanguage :: UsersReputation( string user, string reputation )
{
    string Out = m_CFG->GetString( "oh_187", "oh_187" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$REPUTATION$", reputation);
    return Out;
}

string CLanguage :: UsersOwnReputation( string reputation )
{
    string Out = m_CFG->GetString( "oh_188", "oh_188" );
    UTIL_Replace( Out, "$REPUTATION$", reputation);
    return Out;
}

string CLanguage :: WelcomeUserCreateUniqueId( string user )
{
    string Out = m_CFG->GetString( "oh_189", "oh_189" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}

string CLanguage :: DomainOnJoinNotify( )
{
    string Out = m_CFG->GetString( "oh_190", "oh_190" );
    return Out;
}
...
string CLanguage :: CreatedUniqueIdForNewUser( string id )
{
    string Out = m_CFG->GetString( "oh_192", "oh_192" );
    UTIL_Replace( Out, "$ID$", id);
    return Out;
}

string CLanguage :: PotentialBanAvoider( string user, string count )
{
    string Out = m_CFG->GetString( "oh_193", "oh_193" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$COUNT$", count);
    return Out;
}

string CLanguage :: KickedUserForBeingAFK( string user )
{
    string Out = m_CFG->GetString( "oh_194", "oh_194" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}

string CLanguage :: WarnedUserForBeingAFK( string user )
{
    string Out = m_CFG->GetString( "oh_195", "oh_195" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}
...
string CLanguage :: KickedUserForBeingAfk( string user )
{
    string Out = m_CFG->GetString( "oh_196", "oh_196" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}

string CLanguage :: ErrorForAPMAFKSystem( )
{
    string Out = m_CFG->GetString( "oh_197", "oh_197" );
    return Out;
}

string CLanguage :: UserHasBeenMarkedAPMAFK( string user, string apm )
{
    string Out = m_CFG->GetString( "oh_198", "oh_198" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$APM$", apm);
    return Out;
}

string CLanguage :: UserWarningAPMAFK( string min, string warns )
{
    string Out = m_CFG->GetString( "oh_199", "oh_199" );
    UTIL_Replace( Out, "$MIN$", min );
    UTIL_Replace( Out, "$WARN$", warns);
    return Out;
}

string CLanguage :: UserKickedAPMAFK( string user, string apm, string times, string min )
{
    string Out = m_CFG->GetString( "oh_200", "oh_200" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$APM$", apm);
    UTIL_Replace( Out, "$TIMES$", times );
    UTIL_Replace( Out, "$MIN$", min);
...
{
    string Out = m_CFG->GetString( "oh_201", "oh_201" );
    return Out;
}

string CLanguage :: VoteMuteExpired( string user )
{
    string Out = m_CFG->GetString( "oh_202", "oh_202" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}

string CLanguage :: GameWillBePausedInTicks( string ticks )
{
    string Out = m_CFG->GetString( "oh_203", "oh_203" );
    UTIL_Replace( Out, "$TICKS$", ticks);
    return Out;
}

string CLanguage :: GameWillBeResumedInTicks( string ticks )
{
    string Out = m_CFG->GetString( "oh_204", "oh_204" );
    UTIL_Replace( Out, "$TICKS$", ticks);
    return Out;
}

string CLanguage :: GameWillBeUnpauseInTenSeconds( )
{
    string Out = m_CFG->GetString( "oh_205", "oh_205" );
    return Out;
}

string CLanguage :: UserHaveAHighPingMark( string ping, string times)
{
    string Out = m_CFG->GetString( "oh_206", "oh_206" );
    UTIL_Replace( Out, "$PING$", ping );
    UTIL_Replace( Out, "$TIMES$", times);
    return Out;
}

string CLanguage :: UserCanLeaveBecauseHighPing( )
{
    string Out = m_CFG->GetString( "oh_207", "oh_207" );
    return Out;
}

string CLanguage :: UserCanLeaveBecausePing( string user )
{
    string Out = m_CFG->GetString( "oh_208", "oh_208" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}

string CLanguage :: UserTriedToPause( string user )
{
    string Out = m_CFG->GetString( "oh_209", "oh_209" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}

string CLanguage :: UserTriedToPauseWarnng( )
{
    string Out = m_CFG->GetString( "oh_210", "oh_210" );
    return Out;
}

string CLanguage :: UserGorPunishedForPausing( string user )
{
    string Out = m_CFG->GetString( "oh_211", "oh_211" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}

string CLanguage :: UserGorPunishedForSaving( string user )
{
    string Out = m_CFG->GetString( "oh_212", "oh_212" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}

string CLanguage :: VoteHasBeenEnabledNotify( )
{
    string Out = m_CFG->GetString( "oh_213", "oh_213" );
    return Out;
}

string CLanguage :: VoteStartIsEnabledVotesRequired( string votes )
{
    string Out = m_CFG->GetString( "oh_214", "oh_214" );
    UTIL_Replace( Out, "$VOTES$", votes);
    return Out;
}

string CLanguage :: UserWasKickedForJoiningFromGarena( string user )
{
    string Out = m_CFG->GetString( "oh_215", "oh_215" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}

string CLanguage :: UserJoinedFromGarena( string rank, string user, string realm, string room )
{
    string Out = m_CFG->GetString( "oh_216", "oh_216" );
    UTIL_Replace( Out, "$RANK$", rank);
    UTIL_Replace( Out, "$USER$", user);
    UTIL_Replace( Out, "$REALM$", realm);
    UTIL_Replace( Out, "$ROOM$", room);
    return Out;
}

string CLanguage :: UserJoined( string rank, string user, string realm )
{
    string Out = m_CFG->GetString( "oh_217", "oh_217" );
    UTIL_Replace( Out, "$RANK$", rank);
    UTIL_Replace( Out, "$USER$", user);
    UTIL_Replace( Out, "$REALM$", realm);
    return Out;
...
string CLanguage :: UserJoinedWithHighLeaveRate( string user, string perc)
{
    string Out = m_CFG->GetString( "oh_218", "oh_218" );
    UTIL_Replace( Out, "$USER$", user );
    UTIL_Replace( Out, "$PERC$", perc);
    return Out;
}

string CLanguage :: PreventUserFromTransferResources( string user )
{
    string Out = m_CFG->GetString( "oh_219", "oh_219" );
    UTIL_Replace( Out, "$USER$", user);
    return Out;
}

string CLanguage :: Balance( string sent, string scou)
{
    string Out = m_CFG->GetString( "oh_220", "oh_220" );
    UTIL_Replace( Out, "$SENT$", sent );
    UTIL_Replace( Out, "$SCOU$", scou);
    return Out;
}

string CLanguage :: SpreadWithLockedPlayers( string spread, string locked)
{
    string Out = m_CFG->GetString( "oh_221", "oh_221" );
    UTIL_Replace( Out, "$SPREAD$", spread );
    UTIL_Replace( Out, "$LOCKED$", locked);
    return Out;
}


string CLanguage :: WinChance( string sent, string scou)
{
    string Out = m_CFG->GetString( "oh_222", "oh_222" );
    UTIL_Replace( Out, "$SENT$", sent );
    UTIL_Replace( Out, "$SCOU$", scou);
    return Out;
}

string CLanguage :: YouHaventVotedYet( )
{
    string Out = m_CFG->GetString( "oh_223", "oh_223" );
    return Out;
}

string CLanguage :: PlayersNotVerifiedYet( )
{
    string Out = m_CFG->GetString( "oh_224", "oh_224" );
    return Out;
}

string CLanguage :: PlayersNotVotedYet( )
{
    string Out = m_CFG->GetString( "oh_225", "oh_225" );
    return Out;
}

string CLanguage :: TimeLeftBeforeRandomMode( string left )
{
    string Out = m_CFG->GetString( "oh_226", "oh_226" );
    UTIL_Replace( Out, "$LEFT$", left);
    return Out;
}

string CLanguage :: TimeLeftBeforeTopVotedMode( string left )
{
    string Out = m_CFG->GetString( "oh_227", "oh_227" );
    UTIL_Replace( Out, "$LEFT$", left);
    return Out;
}
...
void CLanguage :: RegisterPythonClass( )
{
	using namespace boost::python;

	class_<CLanguage>("language", no_init)
		.def("unableToCreateGameTryAnotherName", &CLanguage::UnableToCreateGameTryAnotherName)
		.def("userIsAlreadyAnAdmin", &CLanguage::UserIsAlreadyAnAdmin)
		.def("addedUserToAdminDatabase", &CLanguage::AddedUserToAdminDatabase)
		.def("errorAddingUserToAdminDatabase", &CLanguage::ErrorAddingUserToAdminDatabase)
		.def("youDontHaveAccessToThatCommand", &CLanguage::YouDontHaveAccessToThatCommand)
		.def("userIsAlreadyBanned", &CLanguage::UserIsAlreadyBanned)
		.def("bannedUser", &CLanguage::BannedUser)
		.def("errorBanningUser", &CLanguage::ErrorBanningUser)
		.def("userIsAnAdmin", &CLanguage::UserIsAnAdmin)
		.def("userIsNotAnAdmin", &CLanguage::UserIsNotAnAdmin)
		.def("userWasBannedOnByBecause", &CLanguage::UserWasBannedOnByBecause)
		.def("userIsNotBanned", &CLanguage::UserIsNotBanned)
		.def("thereAreNoAdmins", &CLanguage::ThereAreNoAdmins)
		.def("thereIsAdmin", &CLanguage::ThereIsAdmin)
		.def("thereAreAdmins", &CLanguage::ThereAreAdmins)
		.def("thereAreNoBannedUsers", &CLanguage::ThereAreNoBannedUsers)
		.def("thereIsBannedUser", &CLanguage::ThereIsBannedUser)
		.def("thereAreBannedUsers", &CLanguage::ThereAreBannedUsers)
		.def("youCantDeleteTheRootAdmin", &CLanguage::YouCantDeleteTheRootAdmin)
		.def("deletedUserFromAdminDatabase", &CLanguage::DeletedUserFromAdminDatabase)
		.def("errorDeletingUserFromAdminDatabase", &CLanguage::ErrorDeletingUserFromAdminDatabase)
		.def("unbannedUser", &CLanguage::UnbannedUser)
		.def("errorUnbanningUser", &CLanguage::ErrorUnbanningUser)
		.def("gameNumberIs", &CLanguage::GameNumberIs)
		.def("gameNumberDoesntExist", &CLanguage::GameNumberDoesntExist)
		.def("gameIsInTheLobby", &CLanguage::GameIsInTheLobby)
		.def("thereIsNoGameInTheLobby", &CLanguage::ThereIsNoGameInTheLobby)
		.def("unableToLoadConfigFilesOutside", &CLanguage::UnableToLoadConfigFilesOutside)
		.def("loadingConfigFile", &CLanguage::LoadingConfigFile)
		.def("unableToLoadConfigFileDoesntExist", &CLanguage::UnableToLoadConfigFileDoesntExist)
		.def("creatingPrivateGame", &CLanguage::CreatingPrivateGame)
		.def("creatingPublicGame", &CLanguage::CreatingPublicGame)
		.def("unableToUnhostGameCountdownStarted", &CLanguage::UnableToUnhostGameCountdownStarted)
		.def("unhostingGame", &CLanguage::UnhostingGame)
		.def("unableToUnhostGameNoGameInLobby", &CLanguage::UnableToUnhostGameNoGameInLobby)
		.def("versionAdmin", &CLanguage::VersionAdmin)
		.def("versionNotAdmin", &CLanguage::VersionNotAdmin)
		.def("unableToCreateGameAnotherGameInLobby", &CLanguage::UnableToCreateGameAnotherGameInLobby)
		.def("unableToCreateGameMaxGamesReached", &CLanguage::UnableToCreateGameMaxGamesReached)
		.def("gameIsOver", &CLanguage::GameIsOver)
		.def("spoofCheckByReplying", &CLanguage::SpoofCheckByReplying)
		.def("gameRefreshed", &CLanguage::GameRefreshed)
		.def("spoofPossibleIsAway", &CLanguage::SpoofPossibleIsAway)
		.def("spoofPossibleIsUnavailable", &CLanguage::SpoofPossibleIsUnavailable)
		.def("spoofPossibleIsRefusingMessages", &CLanguage::SpoofPossibleIsRefusingMessages)
		.def("spoofDetectedIsNotInGame", &CLanguage::SpoofDetectedIsNotInGame)
		.def("spoofDetectedIsInPrivateChannel", &CLanguage::SpoofDetectedIsInPrivateChannel)
		.def("spoofDetectedIsInAnotherGame", &CLanguage::SpoofDetectedIsInAnotherGame)
		.def("countDownAborted", &CLanguage::CountDownAborted)
		.def("tryingToJoinTheGameButBanned", &CLanguage::TryingToJoinTheGameButBanned)
		.def("unableToBanNoMatchesFound", &CLanguage::UnableToBanNoMatchesFound)
		.def("playerWasBannedByPlayer", &CLanguage::PlayerWasBannedByPlayer)
		.def("unableToBanFoundMoreThanOneMatch", &CLanguage::UnableToBanFoundMoreThanOneMatch)
		.def("addedPlayerToTheHoldList", &CLanguage::AddedPlayerToTheHoldList)
		.def("unableToKickNoMatchesFound", &CLanguage::UnableToKickNoMatchesFound)
		.def("unableToKickFoundMoreThanOneMatch", &CLanguage::UnableToKickFoundMoreThanOneMatch)
		.def("settingLatencyToMinimum", &CLanguage::SettingLatencyToMinimum)
		.def("settingLatencyToMaximum", &CLanguage::SettingLatencyToMaximum)
		.def("settingLatencyTo", &CLanguage::SettingLatencyTo)
		.def("kickingPlayersWithPingsGreaterThan", &CLanguage::KickingPlayersWithPingsGreaterThan)
		.def("hasPlayedGamesWithThisBot", &CLanguage::HasPlayedGamesWithThisBot)
		.def("hasntPlayedGamesWithThisBot", &CLanguage::HasntPlayedGamesWithThisBot)
		.def("autokickingPlayerForExcessivePing", &CLanguage::AutokickingPlayerForExcessivePing)
		.def("spoofCheckAcceptedFor", &CLanguage::SpoofCheckAcceptedFor)
		.def("playersNotYetSpoofChecked", &CLanguage::PlayersNotYetSpoofChecked)
		.def("manuallySpoofCheckByWhispering", &CLanguage::ManuallySpoofCheckByWhispering)
		.def("spoofCheckByWhispering", &CLanguage::SpoofCheckByWhispering)
		.def("everyoneHasBeenSpoofChecked", &CLanguage::EveryoneHasBeenSpoofChecked)
		.def("playersNotYetPinged", &CLanguage::PlayersNotYetPinged)
		.def("everyoneHasBeenPinged", &CLanguage::EveryoneHasBeenPinged)
		.def("shortestLoadByPlayer", &CLanguage::ShortestLoadByPlayer)
		.def("longestLoadByPlayer", &CLanguage::LongestLoadByPlayer)
		.def("yourLoadingTimeWas", &CLanguage::YourLoadingTimeWas)
		//.def("hasPlayedDotAGamesWithThisBot", &CLanguage::HasPlayedDotAGamesWithThisBot)
		.def("hasntPlayedDotAGamesWithThisBot", &CLanguage::HasntPlayedDotAGamesWithThisBot)
		.def("wasKickedForReservedPlayer", &CLanguage::WasKickedForReservedPlayer)
		.def("wasKickedForOwnerPlayer", &CLanguage::WasKickedForOwnerPlayer)
		.def("wasKickedByPlayer", &CLanguage::WasKickedByPlayer)
		.def("hasLostConnectionPlayerError", &CLanguage::HasLostConnectionPlayerError)
		.def("hasLostConnectionSocketError", &CLanguage::HasLostConnectionSocketError)
		.def("hasLostConnectionClosedByRemoteHost", &CLanguage::HasLostConnectionClosedByRemoteHost)
		.def("hasLeftVoluntarily", &CLanguage::HasLeftVoluntarily)
		.def("endingGame", &CLanguage::EndingGame)
		.def("hasLostConnectionTimedOut", &CLanguage::HasLostConnectionTimedOut)
		.def("globalChatMuted", &CLanguage::GlobalChatMuted)
		.def("globalChatUnmuted", &CLanguage::GlobalChatUnmuted)
		.def("shufflingPlayers", &CLanguage::ShufflingPlayers)
		.def("unableToLoadConfigFileGameInLobby", &CLanguage::UnableToLoadConfigFileGameInLobby)
		.def("playersStillDownloading", &CLanguage::PlayersStillDownloading)
		.def("refreshMessagesEnabled", &CLanguage::RefreshMessagesEnabled)
		.def("refreshMessagesDisabled", &CLanguage::RefreshMessagesDisabled)
		.def("atLeastOneGameActiveUseForceToShutdown", &CLanguage::AtLeastOneGameActiveUseForceToShutdown)
		.def("currentlyLoadedMapCFGIs", &CLanguage::CurrentlyLoadedMapCFGIs)
		.def("laggedOutDroppedByAdmin", &CLanguage::LaggedOutDroppedByAdmin)
		.def("laggedOutDroppedByVote", &CLanguage::LaggedOutDroppedByVote)
		.def("playerVotedToDropLaggers", &CLanguage::PlayerVotedToDropLaggers)
		.def("latencyIs", &CLanguage::LatencyIs)
		.def("syncLimitIs", &CLanguage::SyncLimitIs)
		.def("settingSyncLimitToMinimum", &CLanguage::SettingSyncLimitToMinimum)
		.def("settingSyncLimitToMaximum", &CLanguage::SettingSyncLimitToMaximum)
		.def("settingSyncLimitTo", &CLanguage::SettingSyncLimitTo)
		.def("unableToCreateGameNotLoggedIn", &CLanguage::UnableToCreateGameNotLoggedIn)
		.def("adminLoggedIn", &CLanguage::AdminLoggedIn)
		.def("adminInvalidPassword", &CLanguage::AdminInvalidPassword)
		.def("connectingToBNET", &CLanguage::ConnectingToBNET)
		.def("connectedToBNET", &CLanguage::ConnectedToBNET)
		.def("disconnectedFromBNET", &CLanguage::DisconnectedFromBNET)
		.def("loggedInToBNET", &CLanguage::LoggedInToBNET)
		.def("BNETGameHostingSucceeded", &CLanguage::BNETGameHostingSucceeded)
		.def("BNETGameHostingFailed", &CLanguage::BNETGameHostingFailed)
		.def("connectingToBNETTimedOut", &CLanguage::ConnectingToBNETTimedOut)
		.def("playerDownloadedTheMap", &CLanguage::PlayerDownloadedTheMap)
		.def("unableToCreateGameNameTooLong", &CLanguage::UnableToCreateGameNameTooLong)
		.def("settingGameOwnerTo", &CLanguage::SettingGameOwnerTo)
		.def("theGameIsLocked", &CLanguage::TheGameIsLocked)
		.def("gameLocked", &CLanguage::GameLocked)
		.def("gameUnlocked", &CLanguage::GameUnlocked)
		.def("unableToStartDownloadNoMatchesFound", &CLanguage::UnableToStartDownloadNoMatchesFound)
		.def("unableToStartDownloadFoundMoreThanOneMatch", &CLanguage::UnableToStartDownloadFoundMoreThanOneMatch)
		.def("unableToSetGameOwner", &CLanguage::UnableToSetGameOwner)
		.def("unableToCheckPlayerNoMatchesFound", &CLanguage::UnableToCheckPlayerNoMatchesFound)
		.def("checkedPlayer", &CLanguage::CheckedPlayer)
		.def("unableToCheckPlayerFoundMoreThanOneMatch", &CLanguage::UnableToCheckPlayerFoundMoreThanOneMatch)
		.def("theGameIsLockedBNET", &CLanguage::TheGameIsLockedBNET)
		.def("unableToCreateGameDisabled", &CLanguage::UnableToCreateGameDisabled)
		.def("botDisabled", &CLanguage::BotDisabled)
		.def("botEnabled", &CLanguage::BotEnabled)
		.def("unableToCreateGameInvalidMap", &CLanguage::UnableToCreateGameInvalidMap)
		.def("waitingForPlayersBeforeAutoStart", &CLanguage::WaitingForPlayersBeforeAutoStart)
		.def("autoStartDisabled", &CLanguage::AutoStartDisabled)
		.def("autoStartEnabled", &CLanguage::AutoStartEnabled)
		.def("announceMessageEnabled", &CLanguage::AnnounceMessageEnabled)
		.def("announceMessageDisabled", &CLanguage::AnnounceMessageDisabled)
		.def("autoHostEnabled", &CLanguage::AutoHostEnabled)
		.def("autoHostDisabled", &CLanguage::AutoHostDisabled)
		.def("unableToLoadSaveGamesOutside", &CLanguage::UnableToLoadSaveGamesOutside)
		.def("unableToLoadSaveGameGameInLobby", &CLanguage::UnableToLoadSaveGameGameInLobby)
		.def("loadingSaveGame", &CLanguage::LoadingSaveGame)
		.def("unableToLoadSaveGameDoesntExist", &CLanguage::UnableToLoadSaveGameDoesntExist)
		.def("unableToCreateGameInvalidSaveGame", &CLanguage::UnableToCreateGameInvalidSaveGame)
		.def("unableToCreateGameSaveGameMapMismatch", &CLanguage::UnableToCreateGameSaveGameMapMismatch)
		.def("autoSaveEnabled", &CLanguage::AutoSaveEnabled)
		.def("autoSaveDisabled", &CLanguage::AutoSaveDisabled)
		.def("desyncDetected", &CLanguage::DesyncDetected)
		.def("unableToMuteNoMatchesFound", &CLanguage::UnableToMuteNoMatchesFound)
		.def("mutedPlayer", &CLanguage::MutedPlayer)
		.def("unmutedPlayer", &CLanguage::UnmutedPlayer)
		.def("unableToMuteFoundMoreThanOneMatch", &CLanguage::UnableToMuteFoundMoreThanOneMatch)
		.def("playerIsSavingTheGame", &CLanguage::PlayerIsSavingTheGame)
		.def("updatingClanList", &CLanguage::UpdatingClanList)
		.def("updatingFriendsList", &CLanguage::UpdatingFriendsList)
		.def("multipleIPAddressUsageDetected", &CLanguage::MultipleIPAddressUsageDetected)
		.def("unableToVoteKickAlreadyInProgress", &CLanguage::UnableToVoteKickAlreadyInProgress)
		.def("unableToVoteKickNotEnoughPlayers", &CLanguage::UnableToVoteKickNotEnoughPlayers)
		.def("unableToVoteKickNoMatchesFound", &CLanguage::UnableToVoteKickNoMatchesFound)
		.def("unableToVoteKickPlayerIsReserved", &CLanguage::UnableToVoteKickPlayerIsReserved)
		.def("startedVoteKick", &CLanguage::StartedVoteKick)
		.def("unableToVoteKickFoundMoreThanOneMatch", &CLanguage::UnableToVoteKickFoundMoreThanOneMatch)
		.def("voteKickPassed", &CLanguage::VoteKickPassed)
		.def("errorVoteKickingPlayer", &CLanguage::ErrorVoteKickingPlayer)
		.def("voteKickAcceptedNeedMoreVotes", &CLanguage::VoteKickAcceptedNeedMoreVotes)
		.def("voteKickCancelled", &CLanguage::VoteKickCancelled)
		.def("voteKickExpired", &CLanguage::VoteKickExpired)
		.def("wasKickedByVote", &CLanguage::WasKickedByVote)
		.def("typeYesToVote", &CLanguage::TypeYesToVote)
		.def("playersNotYetPingedAutoStart", &CLanguage::PlayersNotYetPingedAutoStart)
		.def("wasKickedForNotSpoofChecking", &CLanguage::WasKickedForNotSpoofChecking)
		.def("wasKickedForHavingFurthestScore", &CLanguage::WasKickedForHavingFurthestScore)
		.def("playerHasScore", &CLanguage::PlayerHasScore)
		.def("ratedPlayersSpread", &CLanguage::RatedPlayersSpread)
		.def("errorListingMaps", &CLanguage::ErrorListingMaps)
		.def("foundMaps", &CLanguage::FoundMaps)
		.def("NoMapsFound", &CLanguage::NoMapsFound)
		.def("errorListingMapConfigs", &CLanguage::ErrorListingMapConfigs)
		.def("foundMapConfigs", &CLanguage::FoundMapConfigs)
		.def("NoMapConfigsFound", &CLanguage::NoMapConfigsFound)
		.def("playerFinishedLoading", &CLanguage::PlayerFinishedLoading)
		.def("pleaseWaitPlayersStillLoading", &CLanguage::PleaseWaitPlayersStillLoading)
		.def("mapDownloadsDisabled", &CLanguage::MapDownloadsDisabled)
		.def("mapDownloadsEnabled", &CLanguage::MapDownloadsEnabled)
		.def("mapDownloadsConditional", &CLanguage::MapDownloadsConditional)
		.def("settingHCL", &CLanguage::SettingHCL)
		.def("unableToSetHCLInvalid", &CLanguage::UnableToSetHCLInvalid)
		.def("unableToSetHCLTooLong", &CLanguage::UnableToSetHCLTooLong)
		.def("theHCLIs", &CLanguage::TheHCLIs)
		.def("theHCLIsTooLongUseForceToStart", &CLanguage::TheHCLIsTooLongUseForceToStart)
		.def("clearingHCL", &CLanguage::ClearingHCL)
		.def("tryingToRehostAsPrivateGame", &CLanguage::TryingToRehostAsPrivateGame)
		.def("tryingToRehostAsPublicGame", &CLanguage::TryingToRehostAsPublicGame)
		.def("rehostWasSuccessful", &CLanguage::RehostWasSuccessful)
		.def("tryingToJoinTheGameButBannedByName", &CLanguage::TryingToJoinTheGameButBannedByName)
		.def("tryingToJoinTheGameButBannedByIP", &CLanguage::TryingToJoinTheGameButBannedByIP)
		.def("hasBannedName", &CLanguage::HasBannedName)
		.def("hasBannedIP", &CLanguage::HasBannedIP)
		.def("playersInGameState", &CLanguage::PlayersInGameState)
		.def("validServers", &CLanguage::ValidServers)
		.def("teamCombinedScore", &CLanguage::TeamCombinedScore)
		.def("balancingSlotsCompleted", &CLanguage::BalancingSlotsCompleted)
		.def("playerWasKickedForFurthestScore", &CLanguage::PlayerWasKickedForFurthestScore)
		.def("localAdminMessagesEnabled", &CLanguage::LocalAdminMessagesEnabled)
		.def("localAdminMessagesDisabled", &CLanguage::LocalAdminMessagesDisabled)
		.def("wasDroppedDesync", &CLanguage::WasDroppedDesync)
		.def("wasKickedForHavingLowestScore", &CLanguage::WasKickedForHavingLowestScore)
		.def("playerWasKickedForLowestScore", &CLanguage::PlayerWasKickedForLowestScore)
		.def("reloadingConfigurationFiles", &CLanguage::ReloadingConfigurationFiles)
		.def("countDownAbortedSomeoneLeftRecently", &CLanguage::CountDownAbortedSomeoneLeftRecently)
		.def("unableToCreateGameMustEnforceFirst", &CLanguage::UnableToCreateGameMustEnforceFirst)
		.def("unableToLoadReplaysOutside", &CLanguage::UnableToLoadReplaysOutside)
		.def("loadingReplay", &CLanguage::LoadingReplay)
		.def("unableToLoadReplayDoesntExist", &CLanguage::UnableToLoadReplayDoesntExist)
		.def("commandTrigger", &CLanguage::CommandTrigger)
		.def("cantEndGameOwnerIsStillPlaying", &CLanguage::CantEndGameOwnerIsStillPlaying)
		.def("cantUnhostGameOwnerIsPresent", &CLanguage::CantUnhostGameOwnerIsPresent)
		.def("wasAutomaticallyDroppedAfterSeconds", &CLanguage::WasAutomaticallyDroppedAfterSeconds)
		.def("hasLostConnectionTimedOutGProxy", &CLanguage::HasLostConnectionTimedOutGProxy)
		.def("hasLostConnectionSocketErrorGProxy", &CLanguage::HasLostConnectionSocketErrorGProxy)
		.def("hasLostConnectionClosedByRemoteHostGProxy", &CLanguage::HasLostConnectionClosedByRemoteHostGProxy)
		.def("waitForReconnectSecondsRemain", &CLanguage::WaitForReconnectSecondsRemain)
		.def("wasUnrecoverablyDroppedFromGProxy", &CLanguage::WasUnrecoverablyDroppedFromGProxy)
		.def("playerReconnectedWithGProxy", &CLanguage::PlayerReconnectedWithGProxy)
	;
}
