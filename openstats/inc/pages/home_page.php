...
if (!isset($website) ) { header('HTTP/1.1 404 Not Found'); die; }
	...
	//GET COMMENTS
	 ...
	 if ( isset($SortComments) AND $SortComments == 3)  $CommentOrder = "date ASC";
	  ...
	  $sth = $db->prepare("SELECT c.*, u.user_name, u.user_fbid, u.user_avatar, u.user_website, u.user_gender, u.user_level, u.phpbb_id, u.smf_id, u.user_bnet
   ...
   <div class="content section" id="main-column">
    <div class="widget Blog padding">
     <div class="blog-posts hfeed padLeft padTop padBottom inner">
	    <h4><?=$lang["points_info1"]?> <a href="<?=OS_HOME?>?profile">+<?=$DailyPoints?> <?=$lang["points_info2"]?></a> <?=$lang["points_info3"]?></h4>
		<div><?=$lang["points_info4"]?></div>
	 </div>
    </div>
   </div>
  </div>
