...
<head>	
  ...
  <link rel="stylesheet" href="themes/ghost/style.css" />
...
<div id="inset">		
				<a href="http://ohsystem.net" class="nounder">
					<img src="http://ohsystem.net/wp-content/themes/OpenHosting/images/blank.gif" style="border:0; float:left; margin-left:20px;" alt="" id="logo">
				</a></div>
<div class="wrapper">  
    ...
    <div id="main-column">
     <div class="padding">
      <div class="inner">
    <div><h2>Install OpenStats 4</h2> </div>
	<div class="post-body entry-content" id="post-body-111111">
	<?php
	//ч
...
<?php 
  if ($_SERVER["REQUEST_METHOD"]=="POST" AND isset($_POST["db_test"]) AND $step==1) {
	...
	<?php
	   ...
	   $sth2 = $dbh->prepare("INSERT INTO `oh_news` (`news_id`, `news_title`, `news_content`, `news_date`, `news_updated`, `views`, `status`, `allow_comments`, `comments`, `author`) 
	   ...
	   $insert_comment = $dbh->prepare("INSERT INTO `oh_comments` (`id`, `user_id`, `page`, `post_id`, `text`, `date`, `user_ip`) 
