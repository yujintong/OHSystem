...
CREATE TABLE IF NOT EXISTS `oh_dotaplayers` (
  ...
  `creepkills` smallint(4) NOT NULL,
  `creepdenies` smallint(4) NOT NULL,
  `assists` smallint(4) NOT NULL,
  `gold` int(11) NOT NULL,
  `neutralkills` smallint(4) NOT NULL,
  ...
  `newcolour` tinyint(1) NOT NULL,
  `towerkills` tinyint(2) NOT NULL,
  `raxkills` tinyint(1) NOT NULL,
  `courierkills` tinyint(1) NOT NULL,
  `level` tinyint(1) NOT NULL,
  `apm` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`),
