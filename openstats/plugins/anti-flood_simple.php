...
if ($PluginEnabled == 1  ) {
    ...
    if ( $_SESSION["last_activity"]>=5 ) {
			...
			print "<html><meta http-equiv='refresh' content='10'><body><h2>Our server is currently overloaded, your request will be repeated automatically in 10 seconds</h2></body></html>";
			die();
	}
