...
<div class="wrapper">   
    <div id="main-column">
     <div class="padding">
      <div class="inner">
  <h4><?php if ($LiveGames==1) { ?><span id="BotStatus"><img src="<?=OS_HOME?>img/BotOffline.png" alt="" width="24" height="24" class="imgvalign" /></span><?php } ?> <?=$lang["recent_games"]?></h4>
<?php
