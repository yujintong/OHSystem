...
<?php } else { ?>
		...
		<b><?=LinkUserProfile($Comment["username"], OS_HOME."?member=".$Comment["user_id"] )?></b>
		</span>, 
<?php } ?>
		<i><?=$Comment["date"]?></i>
		<?=OS_bnet_icon( $Comment["user_bnet"], 16, 16, "imgvalign" )?>
		<?=OS_IsUserGameAdmin( $Comment["user_level"], 1, "imgvalign", 16, 16 )?>
