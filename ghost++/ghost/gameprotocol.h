...
public:
    ...
    void SetRegistered( bool nRegsistered)  {
        m_Registered = nRegsistered;
    }
    void SetScore( uint32_t nScore )          {
        m_Score = nScore;
    }
    void SetCLetter( string nCC )           {
        m_CC = nCC;
    }
    bool GetTransferJoin( )		{
        return m_TransferJoin;
    }
    int GetTransferPID( )		{
        return m_TransferPID;
    }

    void SetTransferJoin( bool nTransferJoin ) {
        m_TransferJoin = nTransferJoin;
    }
    void SetTransferPID( int nTransferPID ) {
        m_TransferPID = nTransferPID;
    }
};
