...
{
        string StorePacket;
        string MinString = UTIL_ToString( ( GetCreationTime( ) ) % 60 );
        string SecString = UTIL_ToString( ( GetCreationTime( ) ) / 60 );
        string LTime = "";
        string GTime = "";
